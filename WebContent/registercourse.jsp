...
<center>
		<h3 class="addTitle">Register For Course</h3>
	</center>
	<center>
		<form action="RegisterCourse" id="coursedetails" name="registerform">
			<table>
				...
				<tr class="colHeight">
					...
					<td  align="center"><input class="myButton"
						...
						type="button" value='Register' onclick="validateCourse()"  id="coursedetails" /></td>
