...
<center>
<h3 class="addTitle">Add Course</h3>
	</center>
	<center>
		<form action="Course" id="coursedetails" name="courseform">
			<table>
				...
				<tr class="colHeightUser">
					<td class="plainText">Course Name</td>
					<td ><input class="htmlText" type="text" name="coursename" /> </td>
					<td ><p class="lblerr" id="cnError"></p></td>
				</tr>
				...
				<tr class="colHeight">
					...
					<td  align="center"><input class="myButton"
						...
						type="button" value='Add Course' onclick="validateAddCourse()"  /></td>
